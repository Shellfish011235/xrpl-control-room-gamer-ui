                ...
                <TabWrap k="regulations">
                  ...
                  {(() => {
                    ...
                    const allItems = [
                      ...
                      { id: 9, type: 'EXEC ORDER', typeColor: 'cyber-green', jurisdiction: 'US', status: 'active', title: 'EO 14178 — Digital Financial Technology', desc: 'Strengthening American Leadership in Digital Financial Technology: policy for open blockchains, dollar stablecoins, banking access, and barring a U.S. CBDC; revokes prior digital-assets EOs.', categories: ['crypto', 'dlt', 'banking'], url: 'https://www.federalregister.gov/documents/2025/01/24/2025-02123/strengthening-american-leadership-in-digital-financial-technology', passLikelihood: 100, xrplImpact: 'positive', industryImpact: 'positive' },
                      { id: 11, type: 'GENIUS', typeColor: 'cyber-green', jurisdiction: 'US', status: 'active', title: 'GENIUS Act — Payment Stablecoins (Pub. L. 119-27)', desc: 'Federal framework for payment stablecoin issuance, reserves, disclosures, and AML/sanctions compliance (S. 1582 enacted July 18, 2025).', categories: ['crypto', 'banking'], url: 'https://www.congress.gov/bill/119th-congress/senate-bill/1582', passLikelihood: 100, xrplImpact: 'positive', industryImpact: 'positive' },
                      ...
                      { id: 42, type: 'CLARITY', typeColor: 'cyber-yellow', jurisdiction: 'US', status: 'pending', title: 'CLARITY Act — Digital Asset Market Structure (H.R. 3633)', desc: 'Defines digital commodities vs securities, expands CFTC spot-market authority, registration paths for exchanges—House advanced 2025; Senate timing TBD.', categories: ['crypto', 'sec', 'dlt'], url: 'https://www.congress.gov/bill/119th-congress/house-bill/3633', passLikelihood: 62, xrplImpact: 'positive', industryImpact: 'positive' },
                      ...
                      { id: 10, type: 'FIT21', typeColor: 'cyber-purple', jurisdiction: 'US', status: 'watch', title: 'FIT21 (H.R. 4763) — precedent, not statute', desc: '118th Congress: passed the House (May 2024) but never became law. SEC/CFTC market-structure ideas carry forward in the CLARITY Act (H.R. 3633) and related 119th Congress bills.', categories: ['crypto', 'sec', 'dlt'], url: 'https://www.congress.gov/bill/118th-congress/house-bill/4763', passLikelihood: null, xrplImpact: 'positive', industryImpact: 'positive' },
                      ...
                      { id: 25, type: 'COPYRIGHT', typeColor: 'cyber-purple', jurisdiction: 'US', status: 'watch', title: 'US Copyright Office — AI & Digital Authorship', desc: 'Ongoing AI study (digital replicas, copyrightability of GenAI outputs, training data). Human authorship still required for registration; NFT/digital-asset guidance evolves here.', categories: ['dlt', 'crypto', 'ai', 'global'], url: 'https://www.copyright.gov/ai/', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'mixed' },
                      ...
                      { id: 37, type: 'WIPO', typeColor: 'cyber-purple', jurisdiction: 'GLOBAL', status: 'watch', title: 'WIPO — AI Infrastructure Interchange (AIII)', desc: 'Global stakeholder forum on technical IP infrastructure for AI: data access, attribution, watermarking, rights metadata, and enforcement tooling (complements WIPO Conversation on IP and AI).', categories: ['ai', 'global'], url: 'https://www.wipo.int/meetings/en/2025/ai-infrastructure-interchange.html', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'positive' },
                      { id: 38, type: 'UPC', typeColor: 'cyber-purple', jurisdiction: 'EU', status: 'watch', title: 'Unified Patent Court (Europe)', desc: 'Central litigation for European patents / Unitary Patents across participating EU states—material for blockchain, fintech, and software patent enforcement strategy in Europe.', categories: ['dlt', 'crypto', 'global'], url: 'https://www.unified-patent-court.org/en', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'positive' },
                      { id: 39, type: 'EUIPO', typeColor: 'cyber-purple', jurisdiction: 'EU', status: 'watch', title: 'EUIPO — EU Trademarks & Designs', desc: 'EU-wide trade mark and registered design filings and disputes; primary registry layer for brand/NFT and digital-product branding strategies alongside national offices.', categories: ['dlt', 'crypto', 'global'], url: 'https://euipo.europa.eu/', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'positive' },
                      { id: 40, type: 'UK IPO', typeColor: 'cyber-purple', jurisdiction: 'GB', status: 'watch', title: 'UK Intellectual Property Office', desc: 'National patents, trade marks, and copyright guidance in the UK (distinct from EUIPO/EPO post-Brexit); relevant for UK-issued digital asset and fintech IP.', categories: ['dlt', 'crypto', 'global'], url: 'https://www.gov.uk/government/organisations/intellectual-property-office', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'positive' },
                      { id: 41, type: 'STATE IP', typeColor: 'cyber-purple', jurisdiction: 'US', status: 'watch', title: 'US State Laws — AI, Deepfakes & Likeness', desc: 'Patchwork of state bills on AI labeling, synthetic media, and personality/likeness rights—intersects with copyright enforcement and tokenized content platforms.', categories: ['ai', 'dlt'], url: 'https://www.ncsl.org/technology/artificial-intelligence-2025-legislation', passLikelihood: null, xrplImpact: 'neutral', industryImpact: 'mixed' },
