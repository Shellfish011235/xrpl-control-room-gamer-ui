...
export interface CrossChainBridge {
  ...
  monthlyVolume?: string; // Estimated monthly transfer volume
  dailyTransactions?: string; // Estimated daily transactions
  avgTransferTime?: string; // Average transfer time
...
export const xrplConnectedChains: XRPLConnectedChain[] = [
  ...
  },
  {
    ...
    symbol: 'EVR',
    type: 'layer1',
    consensus: 'XRPL Hooks + HotPocket',
    evmCompatible: false,
    xrpBridge: true,
    mainnetLaunch: '2023-11',
    githubOrg: 'EvernodeXRPL',
    githubRepos: [
      {
        name: 'evernode-host',
        fullName: 'EvernodeXRPL/evernode-host',
        url: 'https://github.com/EvernodeXRPL/evernode-host',
        description: 'Evernode host software for running decentralized hosting nodes.',
        language: 'JavaScript',
        purpose: 'Host node software',
      },
      {
        name: 'hp-devkit',
        fullName: 'EvernodeXRPL/hp-devkit',
        url: 'https://github.com/EvernodeXRPL/hp-devkit',
        description: 'HotPocket development kit for building smart contracts on Evernode.',
        language: 'JavaScript',
        purpose: 'Developer toolkit',
      },
      {
        name: 'evernode-js-client',
        fullName: 'EvernodeXRPL/evernode-js-client',
        url: 'https://github.com/EvernodeXRPL/evernode-js-client',
        description: 'JavaScript client library for interacting with Evernode.',
        language: 'JavaScript',
        purpose: 'Client SDK',
      },
    ],
    website: 'https://evernode.org',
    docsUrl: 'https://docs.evernode.org',
    explorerUrl: 'https://dashboard.evernode.org',
    description: 'Decentralized cloud computing platform built on XRPL. Uses HotPocket consensus for smart contract execution with EVR token for hosting payments. Enables serverless dApps on XRPL ecosystem.',
    features: [
    ...
    useCases: ['Cloud computing', 'Smart contracts', 'dApps', 'Decentralized hosting'],
    status: 'mainnet',
  },
];
...
export const crossChainBridges: CrossChainBridge[] = [
  ...
  },
  {
    ...
    name: 'Wormhole',
    type: 'lock-mint',
    chains: ['xrpl', 'xrpl-evm-sidechain', 'solana', 'ethereum', 'aptos', 'sui', 'bnb-chain'],
    supportedAssets: ['XRP', 'XRPL tokens', 'MPTs'],
  ...
  },
  {
    ...
    tvl: '$45M',
    monthlyVolume: '$180M',
    dailyTransactions: '3,500+',
    avgTransferTime: '1-3 min',
    fees: '~0.001 XRP',
  ...
  },
  {
    ...
    tvl: '$25M',
    monthlyVolume: '$85M',
    dailyTransactions: '1,200+',
    avgTransferTime: '5-10 min',
    fees: '0.25%',
  ...
  },
  {
    ...
    tvl: '$18M',
    monthlyVolume: '$42M',
    dailyTransactions: '800+',
    avgTransferTime: '3-5 min',
    fees: '0.1%',
  ...
  },
  {
    ...
    tvl: '$12M',
    monthlyVolume: '$28M',
    dailyTransactions: '2,100+',
    avgTransferTime: '2-4 min',
    fees: '0.05%',
  ...
  },
  {
    ...
    tvl: '$5M',
    monthlyVolume: '$12M',
    dailyTransactions: '350+',
    avgTransferTime: '10-15 min',
    fees: '0.1%',
  ...
  },
  {
    ...
    avgTransferTime: '3-5 min',
    fees: '0.15%',
    description: 'Emerging project bridging XRPL and Solana for cross-chain staking, governance, and verified value transfers. Focuses on transparent corridors between XRP Ledger and high-throughput chains.',
    features: ['Cross-chain staking', 'Governance bridge', 'Verified transfers', 'Solana integration'],
    securityModel: 'Multi-sig with validator attestations',
  },
];
